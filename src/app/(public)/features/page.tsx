      ...
      <section className="pt-40 pb-20 px-6 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <p className="text-xl text-muted-foreground/80 font-medium">
            Discover the details around our features.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-bento p-12 shadow-sm border border-border/50 text-foreground">
             <div className="prose prose-lg text-pretty max-w-none">
                <h2>Overview</h2>
                <p>Content for Features has not been finalized yet. This page aligns strictly to the Gradient Labs design system, utilizing the large <strong>bento border</strong> container structure, off-white cream blocks, and highly-legible serif/sans typography pairs.</p>
