    ...
    <div className="bg-background pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16 animate-slide-up">
          <h1 className="text-5xl md:text-6xl  font-medium tracking-tight mb-8">Terms of Service</h1>
        ...
        <div className="prose prose-lg prose-invert max-w-none text-muted-foreground space-y-12 animate-slide-up">
          <section>
            <h2 className="text-3xl  text-white mb-6">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-3xl  text-white mb-6">2. Description of Service</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl  text-white mb-6">3. User Responsibilities</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl  text-white mb-6">4. Intellectual Property</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl  text-white mb-6">5. Limitation of Liability</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl  text-white mb-6">6. Governing Law</h2>
            <p className="leading-relaxed">
