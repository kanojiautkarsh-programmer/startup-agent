  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Start building your startup&apos;s memory today</p>
          </div>

          <Button variant="outline" className="w-full h-11 mb-6" onClick={handleGoogleSignUp} disabled={loading}>
          ...
          {error && (
            <div className="mb-4 p-3 text-sm text-red-500 bg-red-50 dark:bg-red-950 rounded-lg">{error}</div>
          )}
      ...
      <footer className="p-6 text-center text-xs text-muted-foreground">
        ...
        <Link href="/cookies" className="hover:underline mx-2">Cookies</Link>
      </footer>
    </div>
  )
}
