    ...
    <div className="glass-card border border-border/40 rounded-[3rem] p-8 md:p-10 hover:border-primary/20 hover:shadow-2xl transition-all group relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-10">
        <div className="flex items-center gap-8">
          <div className="w-16 h-16 bg-white border border-border shadow-xl rounded-[1.5rem] flex items-center justify-center group-hover:scale-110 transition-transform duration-500 overflow-hidden">
        ...
        {status.connected ? (
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <button
              onClick={handleSync}
              disabled={syncing}
              className="rounded-full px-10 h-14 bg-[#2D211B] text-white hover:bg-primary font-bold text-[10px] uppercase tracking-widest transition-all shadow-2xl disabled:opacity-50 flex items-center gap-3 active:scale-95"
            >
          ...
          <button
            ...
            disabled={connecting}
            className="rounded-full px-10 h-14 bg-[#2D211B] text-white hover:bg-primary font-bold text-[10px] uppercase tracking-widest transition-all shadow-2xl flex items-center gap-3 active:scale-95"
          >
          ...
          <div className="flex flex-wrap gap-3">
            {status.documents?.slice(0, 5).map((doc: any) => (
              <a
                ...
                className="flex items-center gap-2.5 px-5 py-2.5 bg-white border border-border/60 rounded-full text-xs font-medium hover:border-primary/40 hover:shadow-lg transition-all active:scale-95"
              >
